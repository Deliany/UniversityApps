    ...
    public class IMDb
    {
        ...
        private string getUrlData(string url)
        {
            ...
            try
            {
                ...
                Random r = new Random();
                //Random IP Address
                client.Headers["X-Forwarded-For"] = "98.192.142.48";
                    //r.Next(0, 255) + "." + r.Next(0, 255) + "." + r.Next(0, 255) + "." + r.Next(0, 255);
                //Random User-Agent
                client.Headers["User-Agent"] = "Agent: Opera/9.80 (Windows NT 6.1; U; en) Presto/2.10.229 Version/11.61";
                    //"Mozilla/" + r.Next(3, 5) + ".0 (Windows NT " + r.Next(3, 5) + "." + r.Next(0, 2) + "; rv:2.0.1) Gecko/20100101 Firefox/" + r.Next(3, 5) + "." + r.Next(0, 5) + "." + r.Next(0, 5);
